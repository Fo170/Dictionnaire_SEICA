...
Destination variable. It can be a RUN-TIME 
 INTEGER, FLOAT or STRING type variable.

expression

The expression can be a simple assignment (CALC variable=value) or an 
 arithmetic/logic expression:

The values used in the expression can be:

- runtime variables of the type INTEGER
...
In a COMPILED session of the program it 
 executes logical arithmetic calculations and assignments between RUN-TIME 
 constants and variables. This instruction is tipically used with WG and 
 RG instructions.
