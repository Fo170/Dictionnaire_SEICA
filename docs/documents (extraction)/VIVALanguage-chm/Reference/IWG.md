...
The IWG instruction modifies the status of the 
...
Up to 32 channels can be defined in a IWG instruction.

 * 

the IWG command can only be issued in static mode,

 * 

the IWG command is executed immediately without 
 the need of pattern execution

 * 

the group used by the IWG can contain any kind 
 of signal 
