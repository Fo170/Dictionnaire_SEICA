...
~until ( [NOT] 
 variable1 condition constant/variable2/expression );
...
The ~REPEAT instruction must be ended with 
 an ~UNTIL instruction.
...
Executes the body of the ~REPEAT 
 loop until the UNTIL condition is true.
