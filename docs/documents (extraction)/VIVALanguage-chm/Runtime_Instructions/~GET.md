...
specified the variable that should get the result.

__________________________

### Note

- The MEMO ,MAILBOX are always string .

- If the INTO are omitted the result will 
 be in the AR system variable for FLOAT object and into CHAR for strings 

- The PINLIST must 
 be received into an ARRAY ; 

- if the keyword NAME and VAL are omitted the 
