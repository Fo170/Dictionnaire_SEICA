...
..Expect=50kHz (50Hz) this means 50Hz.
...
The mandatory keyword for this instruction 
 is MEASURE F, but it also accepted MEASURE FREQUENCY.
...
NVL instruction to measure a frequency 
 on a test point of the board; the compiler will automatically choose an 
 instrument of the machine that satisfies the request.
